...
/**
	 * This is the Interface of modifying the State of Chashu.
	 * 
	 * @author Xiaochen Liu
	 * @version 1.0
	 */
public class ModifyChashuState {
    ...
    public ModifyChashuState(ManagementControl amc, Ramen arm) {
        mc = amc;
        rm = arm;
        ...
        //2
        Center.add(new JLabel("ChaShu:can be ordered"));
        Cyes = new JLabel();
        if (mc.getChashu(rm)[0] == 1){
            Cyes.setText("Yes");
        }
        else{
            Cyes.setText("No");
        ...
        Center.add(Myes);
        //3
        Center.add(new JLabel("Chashu:can't be ordered"));
        Cno = new JLabel();
        if (mc.getChashu(rm)[1] == 1){
            Cno.setText("Yes");
        }
        else{
            Cno.setText("No");
    ...
    //     ModifyChashuState ms=new ModifyChashuState(mc,rm);
